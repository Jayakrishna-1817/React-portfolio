...
const ExperienceSection = () => {
  const experiences = [
    ...
    },
    {
      ...
      location: "Remote",
      description:
        "Designed, developed, and maintained scalable Android applications using Kotlin and Java in Android Studio. Collaborated with cross-functional teams to deliver high-performance mobile solutions aligned with Google’s Material Design principles.",
      achievements: [
